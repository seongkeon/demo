...
<div class="container">
    ...
    <form action="taxRePw" id="b" method="post">
        <input type="hidden" name="tid" value="${tid}">
        <div class="infolab">새로운 비밀번호</div>
        <input type="password" name="tpwd" id="upwd" required>
        <br>
        <br>
        <div>
        ...
        <br>
        <br>
        <a class="backbtn" id="back" href="taxFindPwd">뒤로가기</a>
    </form>
</div>
</body>
</html>