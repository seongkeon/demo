...
<div class="container">
  ...
  <form action="proRePw" id="b" method="post">
    <input type="hidden" name="pid" value="${pid}">
    <div class="infolab">새로운 비밀번호</div>
    <input type="password" name="ppwd" id="upwd" required>
    <br>
    <br>
    <div>
    ...
    <br>
    <br>
    <a class="backbtn" id="back" href="findPwd">뒤로가기</a>
  </form>
</div>
</body>
</html>